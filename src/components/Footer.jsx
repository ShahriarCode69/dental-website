...
function Footer() {
  return (
    <>
      <section class="py-10 bg-blue-50 sm:pt-16 lg:pt-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <h2 class="text-3xl font-extrabold text-black">Dento.</h2>

              <p class="text-base leading-relaxed text-gray-600 mt-7">We provide gentle and professional dental care to ensure your smile is healthy and radiant. Our team is committed to making your visit as comfortable and effective as possible, with personalized treatment plans.</p>
            ...
            <div>
              ...
              <ul class="mt-6 space-y-4">
                <li>
                  <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Patient Support </a>
                </li>

                <li>
                  <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Appointment Details </a>
                </li>
          ...
          <p class="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by Dento.</p>
        </div>
      </section>
